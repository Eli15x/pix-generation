    ...
    "paths": {
        ...
        "/emissor": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.EmissorReceive"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "EmissorID do emissor",
                        "name": "emissor",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.EmissorDeleteRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/emissor/documento": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Documento do emissor",
                        "name": "documento",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.EmissorDocumentoRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/emissor/id/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Novos dados do emissor",
                        "name": "emissor",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        "model.Client": {
            ...
            "properties": {
                ...
                "clientID": {
                    "description": "ver qual o motivo disso aqui, ta tentando simular o valor do mongo?",
                    "type": "string"
                },
                "cpf": {
                    "type": "string"
